    ...
    <div className="admin-profile-page">
      <div className="page-center-container">
        ...
        <div className="admin-profile-card content-group-box admin-menu-box">
          ...
          <div
            className="admin-menu-item"
            onClick={() => window.open("https://t.me/hi_i_am_sozu", "_blank")}
          >
            <div className="admin-menu-left">
        ...
        >
          ...
          >
            ...
            <div className="admin-modal-header">
              <h3>
                <i className="fas fa-graduation-cap"></i> Шпаргалка для работы
              </h3>
            </div>
            ...
            <div className="admin-modal-body text-instructions">
              <div className="kb-step-card">
                ...
                <p>
                  Зайди на <strong>Главный экран</strong> и нажми на большую
                  круглую кнопку со сканером. Включится камера. Наведи её на
                  экран телефона клиента (там должен быть открыт его QR-код).
                  Приложение пикнет и само откроет его профиль!
                </p>
              </div>
              ...
              <div className="kb-step-card">
                ...
                <p>
                  Когда ты отсканируешь код, приложение само подскажет, какой
                  это заезд. <br />• Если <strong>4-й визит</strong> — посчитай
                  ему услугу ровно за{" "}
                  <strong>половину цены (Скидка 50%)</strong>.<br />• Если{" "}
                  <strong>8-й визит</strong> — это праздник! Мы моем машину{" "}
                  <strong>абсолютно БЕСПЛАТНО</strong>. <br />
                  После этого обязательно нажми кнопку «Подтвердить заезд» на
                  экране.
                </p>
              </div>
              ...
              <div className="kb-step-card">
                ...
                <p>
                  Если у клиента старый телефон, нет интернета или он не хочет
                  скачивать приложение — всё в порядке! На{" "}
                  <strong>Главном экране</strong> нажми маленькую кнопку{" "}
                  <strong>«Оформить гостя»</strong>. Просто руками выбери тип
                  его машины, нужную услугу, способ оплаты и нажми «Создать».
                  Готово!
                </p>
              </div>
            </div>
      ...
      {activeModal === "theme" && (
        ...
        >
          ...
          >
            ...
            <div className="admin-modal-header">
              <h3>
                <i className="fas fa-palette"></i> Цветовая тема
              </h3>
            </div>
            ...
            <div className="admin-modal-body empty-shell">
              <div className="shell-placeholder-notice">
                ...
                <span>
                  Сейчас по умолчанию активна фирменная темная тема панели
                  администратора.
                </span>
              </div>
            </div>
